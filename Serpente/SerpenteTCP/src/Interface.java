...
public class Interface extends JFrame {
  ...
  {
  	//Setando o layout
    super("Distributed Nimbus version TCP");
	...
	clientSnake = new ClientSnake(drawPanel,resultPanel);
     ...
     switch(key)
      {
        case KeyEvent.VK_LEFT:
          clientSnake.send("DIRECAO " + Direction.LEFT);
          
         //esquerda
        break;
        case KeyEvent.VK_RIGHT:
          clientSnake.send("DIRECAO " + Direction.RIGHT);

         //direita
        break;
        case KeyEvent.VK_UP:
          clientSnake.send("DIRECAO " + Direction.UP);
         //cima
        break;
        case KeyEvent.VK_DOWN:
          clientSnake.send("DIRECAO " + Direction.DOWN);
         //baixo
        break;
      }//switch
	}
